...
function Calendar({
  ...
  const dateFormatOptions = getDateFormatOptions(locale);
  ...
  return (
    <DayPicker
      ...
      locale={locale}
      formatters={{
        formatMonthDropdown: (date) => format(date, "LLL", dateFormatOptions),
        ...formatters,
      }}
      classNames={{
...
function CalendarDayButton({
  ...
  return (
    <Button
      ...
      variant="ghost"
      size="icon"
      data-day={format(day.date, "P", dateFormatOptions)}
...
function getDateFormatOptions(locale?: Partial<Locale>) {
  return locale ? { locale: locale as Locale } : undefined;
}
